...
class AppProgressBar extends StatefulWidget {
  ...
  AppProgressBar(
      ...
      this.textStyle = const TextStyle(
          color: Colors.white, fontSize: 14.0, decoration: TextDecoration.none),
      this.padding = const EdgeInsets.all(16.0)});

  static _AppProgressBarState of(BuildContext context) {
    final progressHudState =
        context.findAncestorStateOfType<_AppProgressBarState>();
