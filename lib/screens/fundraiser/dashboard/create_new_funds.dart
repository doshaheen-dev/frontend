                          ...
                          Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    if (country.isEmpty) {
                                      showSnackBar(
                                          context, "Please select a country.");
                                      return;
                                    }
                                    ...
                                    if (cityId <= 0) {
                                      showSnackBar(
                                          context, "Please select a city.");
                                      return;
                                    }
                                    if (_isFundRegulated) {
                                      if (_fundRegulatorController
                                          .text.isEmpty) {
                                        showSnackBar(context,
                                    ...
                                    if (int.parse(_existingFundsController.text
                                                .trim()) >
                                            2100000000 ||
                                        int.parse(_existingFundsController.text
                                                .trim()) <=
                                            0) {
                                      showSnackBar(context,
                                    ...
                                    if (_newFundsController.text.isEmpty) {
                                      showSnackBar(context,
                                          "Please enter the new fund value.");
                                      return;
                                    }
                                    if (int.parse(_newFundsController.text
                                                .trim()) >
                                            2100000000 ||
                                        int.parse(_newFundsController.text
                                                .trim()) <=
                                            0) {
                                      showSnackBar(context,
                                    ...
                                    requestModelInstance.fundExistVal =
                                        int.parse(_existingFundsController.text
                                            .trim());
                                    requestModelInstance.fundNewVal = int.parse(
